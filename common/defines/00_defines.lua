...
NDiplomacy = {
	...
	TRUCE_BREAK_COST_PP = 500,						-- Base cost in PP of breaking a truce by joining a war or accepting a call to war ( you cannot declare war yourself until the truce if up ), this is then multiplied by the time left on the truce ( so once half the truce is up it only cost 50% of this )
	...
	JOINING_NAP_WAR_PENALTY = 0.3,					-- National Unity penalty for breaking non-breakable NAP
	BREAKING_GUARANTEE_PENALTY = 0.1,				-- National Unity penalty for breaking guarantee
...
NCountry = {
	...
	ARMY_SCORE_MULTIPLIER = 1.0,					-- Based on number of armies.
	...
	LOCAL_MANPOWER_ACCESSIBLE_NON_CORE_FACTOR = 0.1,  -- accessible recruitable factor base
	...
	POLITICAL_POWER_CAP = 10000.0,					-- Max amount of political power country should have
	RESISTANCE_IMPORTANT_LEVEL = 0.05,				-- Level when resistance becomes dangerous
	MIN_MAJOR_COUNTRIES	= 8,						-- MIN_MAJOR_COUNTRIES countries with most factories will be considered as major countries
...
NMilitary = {
	...
	ENCIRCLED_PENALTY = -0.45,                      -- penalty when completely encircled
	...
	NUKE_MIN_DAMAGE_PERCENT = 0.3,					-- Minimum damage from nukes as a percentage of current strength/organisation
	...
	NUKE_DELAY_HOURS = 9,							-- How many hours does it take for the nuclear drop to happen
...
NTrade = {
	DISTANCE_TRADE_FACTOR = -0.05,			-- Trade factor is modified by distance times this
	...
	BASE_TRADE_FACTOR = 200,				-- This is the base trade factor
...
NAI = {
	...
	DIPLO_PREFER_OTHER_FACTION = -150,			-- The country has yet to ask some other faction it would prefer to be a part of.
